variable "bucket_name" {
  description = "Name of the S3 bucket for unl3ash"
  type        = string
  default     = "unl3ash-bucket"
}
...
variable "github_repository" {
  ...
  default     = "red512/unl3ash"
}

variable "iam_user_names" {
  type        = list(string)
  description = "List of IAM user names to create and add to the EKS admin group."
  default     = []
}
